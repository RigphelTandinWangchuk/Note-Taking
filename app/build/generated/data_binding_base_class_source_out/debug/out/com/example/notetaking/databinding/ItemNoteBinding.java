...
public final class ItemNoteBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textSnippet;

  @NonNull
  public final TextView textTitle;

  private ItemNoteBinding(@NonNull CardView rootView, @NonNull ImageButton buttonDelete,
      @NonNull TextView textSnippet, @NonNull TextView textTitle) {
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_snippet;
      TextView textSnippet = ViewBindings.findChildViewById(rootView, id);
      if (textSnippet == null) {
        break missingId;
      }
      ...
      return new ItemNoteBinding((CardView) rootView, buttonDelete, textSnippet, textTitle);
    }
